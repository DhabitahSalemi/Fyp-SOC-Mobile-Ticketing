...
public class EscalationTicketAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public EscalationTicketAdapter(Context context, ArrayList<TicketData> list, ArrayList<TicketAssignData> picList,String userRole,String username) {
        ...
        entryHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (userRole != null && userRole.equals("Manager")) {
                    goTo = new Intent(context, TicketEscalationApproval.class);
                    //goTo = new Intent(context, TicketReport.class);
                } else {
                    //goTo = new Intent(context, TicketDetailActivity.class);
                    goTo = new Intent(context, TicketEscalatedDetailActivity.class);
                }
                ...
                assignRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        escalateRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                String ticketPreviousPIC = dataSnapshot.child("requested by").getValue(String.class);
                                String ticketReasons = dataSnapshot.child("reasons").getValue(String.class);
                                String ticketApproveComments = dataSnapshot.child("approveComments").getValue(String.class);
