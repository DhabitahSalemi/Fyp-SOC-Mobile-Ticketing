...
public class ClosedTicketAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ClosedTicketAdapter(Context context, ArrayList<TicketData> list, ArrayList<TicketAssignData> picList,String userRole,String username) {
        ...
        entryHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (userRole != null && userRole.equals("Manager")) {
                    goTo = new Intent(context, TicketClosedDetail.class);
                } else {
                    goTo = new Intent(context, TicketDetailActivity.class);
                    //goTo = new Intent(context, TicketEscalationDetailActivity.class);
                }
