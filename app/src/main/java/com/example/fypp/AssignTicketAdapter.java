...
public class AssignTicketAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AssignTicketAdapter(Context context, ArrayList<TicketData> list, ArrayList<TicketAssignData> picList,String userRole, String username) {
        ...
        entryHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (userRole != null && userRole.equals("Manager")) {
                    goTo = new Intent(context, TicketAssignForm.class);
                } else {
