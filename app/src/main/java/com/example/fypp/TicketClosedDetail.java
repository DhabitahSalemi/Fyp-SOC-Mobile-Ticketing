...
public class TicketClosedDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ticket_closed_detail);
        ...
        nextPageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent goTo = new Intent(TicketClosedDetail.this, TicketClosedDetailPage2.class);
